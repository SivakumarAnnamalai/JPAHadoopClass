 ...
 */
public class CombineFileRecordReaderTest extends RecordReader<LongWritable, Text> {
    ...
    public CombineFileRecordReaderTest(CombineFileSplit inputSplit, TaskAttemptContext context, Integer index) throws IOException {
